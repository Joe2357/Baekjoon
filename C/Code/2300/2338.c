...
int main() {
	...
	printBigInteger(add(createBigInteger(n), createBigInteger(m)));
	printf("\n");
	printBigInteger(subtract(createBigInteger(n), createBigInteger(m)));
	printf("\n");
	printBigInteger(multiply_N2(createBigInteger(n), createBigInteger(m)));
	return 0;
}